...
test_module_package() {
    ...
    assert_contains <(unzip -p "$TEST_ROOT/module.zip" module.prop) 'versionCode=10'
    ...
    assert_contains "$MODULE_ROOT/module.prop" 'version=1.10.0-root-preview.10'
    assert_contains "$MODULE_ROOT/module.prop" 'versionCode=10'
